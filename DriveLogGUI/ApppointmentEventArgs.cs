...
namespace DriveLogGUI
{
    class ApppointmentEventArgs : EventArgs
    {
        ...
        public ApppointmentEventArgs(Label labelAppointment, DateTime fromDate, DateTime toDate, string context, string instructor)
        {
        ...
        {
            return $"Date: {FromDate.ToShortDateString()}";
        }
